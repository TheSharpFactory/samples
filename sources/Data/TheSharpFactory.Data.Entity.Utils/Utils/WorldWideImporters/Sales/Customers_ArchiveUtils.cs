...
{
    public static partial class Customers_ArchiveUtils
    {
    }
}
...
namespace TheSharpFactory.Data.Entity.Utils.WorldWideImporters.Sales
{
    ...
    /// <summary>
    /// This class is a utility class for a TheSharpFactory.Data.Entity.WorldWideImporters.Sales.Customers_Archive.
    /// </summary>
    public static partial class Customers_ArchiveUtils
    {
        /// <summary>
        ...
        public static bool HasChanges(Customers_Archive one, Customers_Archive two)
        {
        ...
        public static void Merge(Customers_Archive source, Customers_Archive target)
        {
        ...
        /// <returns>QueryFilters of Customers_ArchiveProperty</returns>
        public static QueryFilters<Customers_ArchiveProperty> GetChanges(Customers_Archive original, Customers_Archive changed)
        {
            // this method returns a list of changes.
            var changes = new QueryFilters<Customers_ArchiveProperty>(31);
            #region Detect Changes
            if(original.CustomerID != changed.CustomerID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.CustomerID, FilterConditions.Equals, changed.CustomerID));
            if(string.CompareOrdinal(original.CustomerName, changed.CustomerName) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.CustomerName, FilterConditions.Equals, changed.CustomerName));
            if(original.BillToCustomerID != changed.BillToCustomerID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.BillToCustomerID, FilterConditions.Equals, changed.BillToCustomerID));
            if(original.CustomerCategoryID != changed.CustomerCategoryID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.CustomerCategoryID, FilterConditions.Equals, changed.CustomerCategoryID));
            if(original.BuyingGroupID != changed.BuyingGroupID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.BuyingGroupID, FilterConditions.Equals, changed.BuyingGroupID));
            if(original.PrimaryContactPersonID != changed.PrimaryContactPersonID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PrimaryContactPersonID, FilterConditions.Equals, changed.PrimaryContactPersonID));
            if(original.AlternateContactPersonID != changed.AlternateContactPersonID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.AlternateContactPersonID, FilterConditions.Equals, changed.AlternateContactPersonID));
            if(original.DeliveryMethodID != changed.DeliveryMethodID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryMethodID, FilterConditions.Equals, changed.DeliveryMethodID));
            if(original.DeliveryCityID != changed.DeliveryCityID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryCityID, FilterConditions.Equals, changed.DeliveryCityID));
            if(original.PostalCityID != changed.PostalCityID)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PostalCityID, FilterConditions.Equals, changed.PostalCityID));
            if(original.CreditLimit != changed.CreditLimit)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.CreditLimit, FilterConditions.Equals, changed.CreditLimit));
            if(original.AccountOpenedDate != changed.AccountOpenedDate)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.AccountOpenedDate, FilterConditions.Equals, changed.AccountOpenedDate));
            if(original.StandardDiscountPercentage != changed.StandardDiscountPercentage)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.StandardDiscountPercentage, FilterConditions.Equals, changed.StandardDiscountPercentage));
            if(original.IsStatementSent != changed.IsStatementSent)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.IsStatementSent, FilterConditions.Equals, changed.IsStatementSent));
            if(original.IsOnCreditHold != changed.IsOnCreditHold)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.IsOnCreditHold, FilterConditions.Equals, changed.IsOnCreditHold));
            if(original.PaymentDays != changed.PaymentDays)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PaymentDays, FilterConditions.Equals, changed.PaymentDays));
            if(string.CompareOrdinal(original.PhoneNumber, changed.PhoneNumber) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PhoneNumber, FilterConditions.Equals, changed.PhoneNumber));
            if(string.CompareOrdinal(original.FaxNumber, changed.FaxNumber) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.FaxNumber, FilterConditions.Equals, changed.FaxNumber));
            if(string.CompareOrdinal(original.DeliveryRun, changed.DeliveryRun) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryRun, FilterConditions.Equals, changed.DeliveryRun));
            if(string.CompareOrdinal(original.RunPosition, changed.RunPosition) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.RunPosition, FilterConditions.Equals, changed.RunPosition));
            if(string.CompareOrdinal(original.WebsiteURL, changed.WebsiteURL) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.WebsiteURL, FilterConditions.Equals, changed.WebsiteURL));
            if(string.CompareOrdinal(original.DeliveryAddressLine1, changed.DeliveryAddressLine1) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryAddressLine1, FilterConditions.Equals, changed.DeliveryAddressLine1));
            if(string.CompareOrdinal(original.DeliveryAddressLine2, changed.DeliveryAddressLine2) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryAddressLine2, FilterConditions.Equals, changed.DeliveryAddressLine2));
            if(string.CompareOrdinal(original.DeliveryPostalCode, changed.DeliveryPostalCode) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryPostalCode, FilterConditions.Equals, changed.DeliveryPostalCode));
            if(original.DeliveryLocation != changed.DeliveryLocation)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.DeliveryLocation, FilterConditions.Equals, changed.DeliveryLocation));
            if(string.CompareOrdinal(original.PostalAddressLine1, changed.PostalAddressLine1) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PostalAddressLine1, FilterConditions.Equals, changed.PostalAddressLine1));
            if(string.CompareOrdinal(original.PostalAddressLine2, changed.PostalAddressLine2) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PostalAddressLine2, FilterConditions.Equals, changed.PostalAddressLine2));
            if(string.CompareOrdinal(original.PostalPostalCode, changed.PostalPostalCode) != 0)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.PostalPostalCode, FilterConditions.Equals, changed.PostalPostalCode));
            if(original.LastEditedBy != changed.LastEditedBy)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.LastEditedBy, FilterConditions.Equals, changed.LastEditedBy));
            if(original.ValidFrom != changed.ValidFrom)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.ValidFrom, FilterConditions.Equals, changed.ValidFrom));
            if(original.ValidTo != changed.ValidTo)
                changes.Add(QueryFilter.New(Customers_ArchiveProperty.ValidTo, FilterConditions.Equals, changed.ValidTo));
            #endregion
