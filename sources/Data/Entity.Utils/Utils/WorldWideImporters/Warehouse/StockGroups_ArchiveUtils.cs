...
{
    public static partial class StockGroups_ArchiveUtils
    {
    }
}
...
namespace TheSharpFactory.Data.Entity.Utils.WorldWideImporters.Warehouse
{
    ...
    /// <summary>
    /// This class is a utility class for a TheSharpFactory.Data.Entity.WorldWideImporters.Warehouse.StockGroups_Archive.
    /// </summary>
    public static partial class StockGroups_ArchiveUtils
    {
        /// <summary>
        ...
        public static bool HasChanges(StockGroups_Archive one, StockGroups_Archive two)
        {
        ...
        public static void Merge(StockGroups_Archive source, StockGroups_Archive target)
        {
        ...
        /// <returns>QueryFilters of StockGroups_ArchiveProperty</returns>
        public static QueryFilters<StockGroups_ArchiveProperty> GetChanges(StockGroups_Archive original, StockGroups_Archive changed)
        {
            // this method returns a list of changes.
            var changes = new QueryFilters<StockGroups_ArchiveProperty>(5);
            #region Detect Changes
            if(original.StockGroupID != changed.StockGroupID)
                changes.Add(QueryFilter.New(StockGroups_ArchiveProperty.StockGroupID, FilterConditions.Equals, changed.StockGroupID));
            if(string.CompareOrdinal(original.StockGroupName, changed.StockGroupName) != 0)
                changes.Add(QueryFilter.New(StockGroups_ArchiveProperty.StockGroupName, FilterConditions.Equals, changed.StockGroupName));
            if(original.LastEditedBy != changed.LastEditedBy)
                changes.Add(QueryFilter.New(StockGroups_ArchiveProperty.LastEditedBy, FilterConditions.Equals, changed.LastEditedBy));
            if(original.ValidFrom != changed.ValidFrom)
                changes.Add(QueryFilter.New(StockGroups_ArchiveProperty.ValidFrom, FilterConditions.Equals, changed.ValidFrom));
            if(original.ValidTo != changed.ValidTo)
                changes.Add(QueryFilter.New(StockGroups_ArchiveProperty.ValidTo, FilterConditions.Equals, changed.ValidTo));
            #endregion
