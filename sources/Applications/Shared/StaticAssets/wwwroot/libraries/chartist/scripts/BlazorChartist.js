...
/******/ 	return __webpack_require__(__webpack_require__.s = "./BlazorChartist.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var BlazorChartist = /** @class */ (function () {
    function BlazorChartist() {
    }
    BlazorChartist.createChart = function (elem, type) {
        var constructor = Chartist[type];
        var chart = new constructor(elem, { series: [] });
        elem['_chart'] = chart;
    };
    BlazorChartist.updateChart = function (elem, data, options) {
        elem['_chart'].update(data, options);
    };
    return BlazorChartist;
}());
exports["default"] = BlazorChartist;
...
/******/ })["default"];
//# sourceMappingURL=BlazorChartist.js.map